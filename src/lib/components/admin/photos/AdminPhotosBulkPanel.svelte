...
<section class="mt-4 grid gap-3">
  <div
    class="flex flex-wrap items-center gap-2 text-xs tracking-[var(--tracking-tight)] uppercase"
  >
  ...
  <div class="flex flex-wrap items-center gap-2">
    ...
    {#if onToggleShowBulkTaxonomy}
      <label
        class="ml-auto flex cursor-pointer items-center gap-2 text-xs tracking-[var(--tracking-tight)] uppercase"
      >
        <input
          type="checkbox"
