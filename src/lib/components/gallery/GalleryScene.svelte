<script lang="ts">
  ...
  /** Target rect for promoted photo: full viewport. The img uses object-fit:contain so it fills height or width and centers. */
...
<style>
  ...
  :global([data-full-viewport] .tile-img) {
    max-width: 100%;
    max-height: 100%;
    width: auto;
    height: auto;
