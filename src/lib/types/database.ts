    ...
    Tables: {
      ...
      gallery_settings: {
        Row: {
          ...
          classic_detail_border_px: number;
          classic_detail_h_inset_pct: number;
          classic_detail_v_inset_pct: number;
          classic_detail_v_position_pct: number;
